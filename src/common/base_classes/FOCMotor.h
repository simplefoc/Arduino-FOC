...
public:
  ...
  FOCModulationType
      foc_modulation; //!<  parameter derterniming modulation algorithm
  ...
  PIDController PID_velocity{DEF_PID_VEL_P, DEF_PID_VEL_I, DEF_PID_VEL_D,
                             DEF_PID_VEL_RAMP,
                             DEF_PID_VEL_LIMIT}; //!< parameter determining the
  ...
  uint8_t monitor_variables =
      ...
      _MON_ANGLE; //!< Bit array holding the map of variables the user wants to
                  //!< monitor
