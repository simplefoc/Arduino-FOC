...
public:
   ...
   *   All the necessary intialisations of adc and sync should be implemented
   * here
   */
  virtual void init() = 0;

  /**
   * Function intended to implement all that is needed to sync and current
   * sensing with the driver. If no such thing is needed it can be left empty
   * (return 1)
