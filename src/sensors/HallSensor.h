...
public:
  ...
  @param pp  pole pairs  (e.g hoverboard motor has 15pp and small gimbals often
  have 7pp)
  ...
  */
  ...
  void init();
  /**
   *  function enabling hardware interrupts for the HallSensor channels with
   * provided callback functions if callback is not provided then the interrupt
   * is not enabled
   *
  ...
  // this is sometimes useful to identify interrupt issues (e.g. weak or no
  // pullup resulting in 1000s of interrupts)
