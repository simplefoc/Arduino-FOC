...
/**
 * This sensor has been tested with AS5600 running in 'analog mode'.  This is
 * where output pin of AS6000 is connected to an analog pin on your
 * microcontroller. This approach is very simple but you may more accurate
 * results with MagneticSensorI2C if that is also supported as its skips the DAC
 * -> ADC conversion (ADC supports MagneticSensorI2C)
 */
...
public:
  ...
  /** raw count (typically in range of 0-1023), useful for debugging resolution
   * issues */
  int raw_count;
