...
extern tccConfiguration
    tccPinConfigurations[SIMPLEFOC_SAMD_MAX_TCC_PINCONFIGURATIONS];
...
void configureTCC(tccConfiguration &tccConfig, long pwm_frequency,
                  bool negate = false, float hw6pwm = -1);
