...
public:
  ...
  */
  BLDCDriver6PWM(int phA_h, int phA_l, int phB_h, int phB_l, int phC_h,
                 int phC_l, int en = NOT_SET);
  ...
  float dead_zone; //!< a percentage of dead-time(zone) (both high and low side
                   //!< in low) for each pwm cycle [0,1]
