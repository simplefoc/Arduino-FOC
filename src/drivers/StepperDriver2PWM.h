...
public:
  ...
  */
  StepperDriver2PWM(int pwm1, int in1a, int in1b, int pwm2, int in2a, int in2b,
                    int en1 = NOT_SET, int en2 = NOT_SET);
  ...
  /**
    ...
    @param en2 enable pin phase 2 (optional input)
  */
  StepperDriver2PWM(int pwm1, int dir1, int pwm2, int dir2, int en1 = NOT_SET,
                    int en2 = NOT_SET);
