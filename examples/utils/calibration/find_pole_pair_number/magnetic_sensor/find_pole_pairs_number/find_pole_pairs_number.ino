 ...
 *
 * To run it just set the correct pin numbers for the BLDC driver and sensor CPR
 * value and chip select pin.
 *
...
void setup() {
  ...
  if (pp <= 0) {
    ...
    Serial.println(F(" - Try changing the search_voltage value or motor/sensor "
                     "configuration."));
    return;
  } else if (pp > 30) {
