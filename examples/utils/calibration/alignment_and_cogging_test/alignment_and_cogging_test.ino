...
void testAlignmentAndCogging(int direction) {
  ...
  Serial.println();
  Serial.println(F("Plotting 3rd column of data (electricAngleError) will "
                   "likely show sinusoidal cogging pattern with a frequency of "
                   "4xpole_pairs per rotation"));
  Serial.println();
}
