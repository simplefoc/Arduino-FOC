 ...
 *
 * This board doesn't have any interrupt pins so we need to run all the encoder
 * channels with the software interrupt library
 * - For this example we use: PciManager library :
