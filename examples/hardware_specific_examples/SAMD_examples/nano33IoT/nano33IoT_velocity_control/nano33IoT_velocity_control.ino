...
// set this #define SIMPLEFOC_SAMD_DEBUG in
// drivers/hardware_specific/samd21_mcu.h
...
// 3-PWM driving on pins 6, 5 and 8 - these are all on the same timer unit
// (TCC0), but different channels
